...
personality(estj,A,B,C,D):- A = extrovert, B = sensory, C = thinking, D = judging.
personality(estp,A,B,C,D):- A = extrovert, B = sensory, C = thinking, D = perceiving.
personality(esfp,A,B,C,D):- A = extrovert, B = sensory, C = feeling, D = perceiving.
personality(esfj,A,B,C,D):- A = extrovert, B = sensory, C = feeling, D = judging.
personality(istj,A,B,C,D):- A = introvert, B = sensory, C = thinking, D = judging.
personality(istp,A,B,C,D):- A = introvert, B = sensory, C = thinking, D = perceiving.
personality(isfp,A,B,C,D):- A = introvert, B = sensory, C = feeling, D = perceiving.
personality(isfj,A,B,C,D):- A = introvert, B = sensory, C = feeling, D = judging.
personality(intj,A,B,C,D):- A = introvert, B = intuitive, C = thinking, D = judging.
personality(intp,A,B,C,D):- A = introvert, B = intuitive, C = thinking, D = perceiving.
personality(infp,A,B,C,D):- A = introvert, B = intuitive, C = feeling, D = perceiving.
personality(infp,A,B,C,D):- A = introvert, B = intuitive, C = feeling, D = judging.
personality(entj,A,B,C,D):- A = extrovert, B = intuitive, C = thinking, D = judging.
personality(entp,A,B,C,D):- A = extrovert, B = intuitive, C = thinking, D = perceiving.
personality(enfp,A,B,C,D):- A = extrovert, B = intuitive, C = feeling, D = perceiving.
personality(enfj,A,B,C,D):- A = extrovert, B = intuitive, C = feeling, D = judging.
